        ...
        switch ($_POST['action']) {
            case 'create':
                ...
                if ($kategori->create()) {
                    ...
                    $message = 'Gagal menambahkan kategori bahan!';
                    $message_type = 'error';
                }
                break;
            ...
            case 'update':
                ...
                if ($kategori->update()) {
                    ...
                    $message = 'Gagal memperbarui kategori bahan!';
                    $message_type = 'error';
                }
                break;
            ...
            case 'delete':
                ...
                if ($kategori->delete()) {
                    ...
                    $message = 'Gagal menghapus kategori bahan!';
                    $message_type = 'error';
                }
                break;
        }
...
<head>
    ...
    <title>Kategori bahan - <?php echo APP_NAME; ?></title>
            ...
            <div class="content">
                ...
                <div class="table-container">
                    <div class="table-header">
                        <h3 class="table-title">Daftar Kategori bahan</h3>
                    </div>
                    <table class="table">
                        <thead>
                            <tr>

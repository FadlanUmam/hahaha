...
if ($role === 'admin' || $role === 'gudang') {
    // Get bahan stats
    $bahan = new Bahan($db);
    $total_bahan = $bahan->getTotalBahan();
    $stok_minimum = $bahan->getStokMinimum();
            ...
            <div class="content">
                ...
                <div class="dashboard-grid">
                    ...
                    <div class="dashboard-card">
                        ...
                        <div class="card-value"><?php echo $total_bahan ?? 0; ?></div>
                        <div class="card-subtitle">Jumlah jenis bahan</div>
                    </div>
                    ...
                    <div class="dashboard-card">
                        ...
                        <div class="card-subtitle">bahan dengan stok minimum</div>
                    </div>
                    <?php endif; ?>
